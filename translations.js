...
const TRANSLATIONS = {
  uz: {
    ...
    about: {
      title: "Biz haqimizda",
      subtitle: "NextTrip Travel Agency bilan tanishing",
  ...
  ru: {
    ...
    about: {
      title: "О нас",
      subtitle: "Познакомьтесь с NextTrip Travel Agency",
  ...
  en: {
    ...
    about: {
      title: "About Us",
      subtitle: "Get to know NextTrip Travel Agency",
